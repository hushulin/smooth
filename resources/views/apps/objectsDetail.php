    ...
    <table data-name="<?php echo $item->body_name; ?>" data-id="<?php echo $item->id; ?>" data-period="<?php echo $period; ?>" class="objectsDetail">
        ...
        <tbody>
            ...
            <tr data-id="<?php echo $item->id; ?>">
                <td colspan="5"><p>更新时间: <span class="updateTime"><?php echo date('Y-m-d H:i:s', strtotime($item->updated_at)); ?></span></p></td>
                <td colspan="5" style="text-align:right;">
                   <!--<button id="boll">布林线</button>-->
                   <button id="ma">均线</button>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                    <div id="stakeSelector" class="selector">
                        <label for="select_stake">交易金额</label>
                ...
                <table>
                    ...
                    <tr>
                        <td style="width: 50%; line-height: 1.5em; padding: 12px 0; border-bottom: 0;">
                            ...
                            <span class="gpu content price">
                            <span id="donePrice" class="content price <?php
                                if($item->body_price_previous > $item->body_price) echo 'green';
                                else echo 'red';  
                            ?>"><?php echo(sprintf('%.' . $item->body_price_decimal . 'f', $item->body_price)); ?></span></span>

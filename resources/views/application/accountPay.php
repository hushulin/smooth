...
<div class="box">
  <form id="form" class="form-inline" onsubmit='return false;'>
    <ul class='box_' id="box">
      <li>100<span>元</span><input onclick='change(1)' type="number" name="price" value="100" readonly></li>
      <li>200<span>元</span><input onclick='change(4)' type="number" name="price" value="200" readonly></li>
      <li>500<span>元</span><input onclick='change(2)' type="number" name="price" value="500" readonly></li>
      <li>1000<span>元</span><input onclick='change(3)' type="number" name="price" value="1000" readonly></li>
    </ul>

                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/administrator/orders?id_user=<?php echo $item->id_wechat; ?>">订单记录</a> | <a href="/administrator/records?id_user=<?php echo $item->id_wechat; ?>">资金记录</a> | <a href="/administrator/payRequests?id_user=<?php echo $item->id_wechat; ?>">充值记录</a> | <a href="/administrator/withdrawRequests?id_user=<?php echo $item->id_wechat; ?>">提现记录</a> | <a href="/administrator/payRequests/<?php echo $item->id_wechat; ?>">人工充值</a> | <a href="/administrator/users/<?php echo $item->id_wechat; ?>/withhold">人工扣款</a> | <a href="/administrator/users?id_introducer=<?php echo $item->id_wechat; ?>">名下用户</a> | <a href="/administrator/users/<?php echo $item->id_wechat; ?>/status">封禁切换</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
